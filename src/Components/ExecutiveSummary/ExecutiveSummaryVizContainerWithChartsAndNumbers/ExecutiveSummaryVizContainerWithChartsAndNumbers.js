...
const ExecutiveSummaryVizContainerWithChartsAndNumbers = (props) => {
    ...
    return (
        <div className='exact-summary-viz-container'>
            {/* <div>
                <h1>Digital</h1>
            </div> */}
            <div className='exact-summary-viz-container-2'>
                <div className='exact-summary-viz-container-left'>
                    <div className='exact-summary-viz-number-container'>
