  ...
  return (
    <div className="excutive-summary">
      ...
      <div className="main-excutive-summary">
        ...
        <div className="executive-summary-digital-watchtime">
